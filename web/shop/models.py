...
class Category(db.Model):
    ...
    products = db.relationship(
        "Product", back_populates="category", cascade="all, delete, delete-orphan"
    )
...
class Product(db.Model):
    ...
    order_items = db.relationship(
        "OrderItem", back_populates="products", cascade="all, delete, delete-orphan"
    )
...
class Order(db.Model):
    ...
    created_at = db.Column(
        db.DateTime(timezone=True), unique=False, nullable=False, default=func.now()
    )
